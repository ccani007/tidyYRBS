...
data_yrbs_2019_race <- 
  ...
  select(- c(weight, stratum, psu, n_suicide_attempts, Race, Q4, suicide_planned, 
             suicide_attempts, suicide_injury))
...
# This is to observe the new data after tranforming nominals to dummies
...
Before running the model I will use 10-fold cross validation to find the best Complexity Parameter for the decision tree using this code:

```{r crossvalidation}

cv_folds <-
  vfold_cv(analysis_train, 
           v = 10,  # the number of sets
