...
https://stats.stackexchange.com/questions/102812/machine-learning-with-weighted-complex-survey-data 
...
data_yrbs_2019_race <- 
  ...
  select(- c(stratum, psu, n_suicide_attempts, Race, Q4,          suicide_planned, suicide_attempts, suicide_injury, weight))
...
```{r}
set.seed(2)
sim_folds <- vfold_cv(data_yrbs_2019_race , strata = suicide_considered)
```
