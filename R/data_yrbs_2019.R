...
#' @docType data
#' 
#' @usage data(yrbs_2019)
#' 
#' @description This is the imported 2019 YRBS Data. This data set monitors
...
#'     inthe United States. These behaviors, often include:
#'     
#' \itemize{
...
#' }
#'
#'@format A tibble with 13,677 and 246 variables
#'\describe{
#'  The data includes 99 items and 246 variables in total. 
